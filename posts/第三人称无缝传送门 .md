...
![Portal](./Image/portal/Portal.gif)
...
![47a32ece-43d4-4ea5-9153-8da79796bf27](./Image/portal/47a32ece-43d4-4ea5-9153-8da79796bf27.png)
...
![image](./Image/portal/image.png)

**变换逻辑：**

玩家相机的世界坐标系相对于**触发门** A 的变换，经过一次镜像旋转（绕门 A 的上方向轴旋转 180 度）后，即为**关联门** B 的虚拟相机相对于门 B 的变换。*(虚拟相机的俯仰角 Pitch 和翻滚角 Roll 相较于玩家相机而言保持不变)*。

![0076ab2e-e4c3-4b31-8ccd-a70e8d324d70](./Image/portal/0076ab2e-e4c3-4b31-8ccd-a70e8d324d70.png)
...
![c0409ad8-241f-4b66-b8f2-99ee035f6962](./Image/portal/c0409ad8-241f-4b66-b8f2-99ee035f6962.png)
...
![938d9cb7-b50a-4359-87ac-311d1e2029f1](./Image/portal/938d9cb7-b50a-4359-87ac-311d1e2029f1.png)
...
![image 1](./Image/portal/image 1.png)
...
![1e43b177-741f-4923-87b6-dcec9c65d83c](./Image/portal/1e43b177-741f-4923-87b6-dcec9c65d83c.png)
...
![image 2](./Image/portal/image 2.png)
...
![image 3](./Image/portal/image 3.png)
...
![045154f0-c62f-4e88-9529-ecfcc32b34c1](./Image/portal/045154f0-c62f-4e88-9529-ecfcc32b34c1.png)

**镜像角色**

对于用来复制姿势的镜像角色，我们会在其穿越前进行显示，可能存在显示时，由于可见性设置的原因，骨骼姿势尚未更新而导致在第一帧出现错误姿势，尤其是其第一次显示时最为明显（因为初始姿势是T Pose），为了解决这穿帮的一帧，可以做以下设置：

![image 4](./Image/portal/image 4.png)
